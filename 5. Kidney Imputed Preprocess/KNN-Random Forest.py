...
# Load the dataset
df = pd.read_csv('5. Kidney Imputed Preprocess/5. kidney-imputed-preprocess-rev.csv')
...
print("Voting Accuracy: {:.4f}".format(voting_acc*100))
print("Voting Precision: {:.4f}".format(voting_prec*100))
print("Voting Recall: {:.4f}".format(voting_rec*100))
